...
/**
 * Working - It checks every element in the array and swaps if some condition mets.
 * There are two for loops which iterate over the array. 
 * First loop starts with first element in the array and move along to the last element.
 * Step1 - The inner for loop then compares(which is smaller) the outter loop pointer.
 * Step2 - if the inner loop pointer element is smaller, we can swap the elements.

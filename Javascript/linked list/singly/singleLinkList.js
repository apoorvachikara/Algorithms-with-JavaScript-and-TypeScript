...
class LinkList {
  ...
  /**
       ...
       * @param {*} index : number
       *
       * We need to insert a data at given index- itreate through
       * linklist using two pointer prev and current
       * create new node = update prev.next with node and
       * new node.next with current
       */
